...
@Component({
  ...
  templateUrl: './scp-certificates.component.html',
  styleUrl: './scp-certificates.component.css'
})
export class ScpCertificatesComponent implements AfterViewInit {
